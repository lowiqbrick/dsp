...
pub mod items {
    ...
    use super::{essentials::item_logic::{IsItem, Item, ItemAmount, ManFac, ManFac::{Assembler, Furnace, Lab, ChemicalPlant, MiniatureParticleCollider}, Recipe}, hello_essentials};
    ...
    pub fn get_items<'a>(mut res_hash: HashMap<String, Item>) -> HashMap<String, Item> {
        ...
        tohash!(res_hash,
            ...
            item!("Titanium Alloy",
                (Furnace),
                (recipe!(12.0,
                    (recitem!(8, "Sulfuric Acid"), recitem!(4, "Steel"), recitem!(4, "Titanium Ingot")),
        ...
        tohash!(res_hash,
            super_magentic_ring,
            "Super-magnetic Ring",
            item!("Super-magnetic Ring",
                (Assembler),
                (recipe!(3.0,
                    (recitem!(1, "Energetic Graphite"), recitem!(3, "Magnet"), recitem!(2, "Electromagnetic Turbine")),
        ...
        tohash!(res_hash,
            ...
            item!("Particle Container",
                (Assembler),
                (recipe!(4.0,
                    (recitem!(2, "Graphene"), recitem!(2, "Copper Ingot"), recitem!(2, "Electromagnetic Turbine")),
        ...
        tohash!(res_hash,
            ...
            item!("Plastic",
                (ChemicalPlant),
                (recipe!(3.0,
                    (recitem!(1, "Energetic Graphite"), recitem!(2, "Refined Oil")),
                    (recitem!(1, "Plastic"))))));
        tohash!(res_hash,
            organic_crystal,
            "Organic Crystal",
            item!("Organic Crystal",
                (ChemicalPlant),
                (recipe!(6.0,
                    (recitem!(1, "Water"), recitem!(1, "Refined Oil"), recitem!(2, "Plastic")),
                    (recitem!(1, "Organic Crystal"))),
                recipe!(6.0,
                    (recitem!(10, "Water"), recitem!(30, "Plant Fuel"), recitem!(20, "Log"),),
                    (recitem!(1, "Organic Crystal"))))));
        ...
        graphene =
            Item::new(
                ...
                vec![Recipe::new(
                    3.0,
                    vec![IsItem::new(ItemAmount::new(1, String::from("Sulfuric Acid"))),
        ...
        tohash!(res_hash,
            ...
            item!("Annihilation Constraint Sphere",
                (Assembler),
                (recipe!(20.0,
        ...
        tohash!(res_hash,
            ...
            item!("Strange Matter",
                ...
                (recipe!(8.0,
                    (recitem!(10, "Deuterium"), recitem!(2, "Iron Ingot"), recitem!(1, "Particle Container")),
                    (recitem!(1, "Strange Matter"))))));
        tohash!(res_hash,
            titanium_crystal,
            "Titanium Crystal",
            item!("Titanium Crystal",
                (Assembler),
                (recipe!(4.0,
                    (recitem!(3, "Titanium Ingot"), recitem!(1, "Organic Crystal")),
        ...
        tohash!(res_hash,
            particle_broadband,
            "Particle Broadband",
            item!("Particle Broadband",
                (Assembler),
                (recipe!(8.0,
                    (recitem!(1, "Plastic"), recitem!(2, "Crystal Silicon"), recitem!(2, "Carbon Nanotube")),
                    (recitem!(1, "Particle Broadband"))))));
        tohash!(res_hash,
            casimir_crystal,
            "Casimir Crystal",
            item!("Casimir Crystal",
                (Assembler),
                (recipe!(4.0,
                    (recitem!(12, "Hydrogen"), recitem!(2, "Graphene"), recitem!(1, "Titanium Crystal")),
                    (recitem!(1, "Casimir Crystal"))),
                recipe!(4.0,
                    (recitem!(12, "Hydrogen"), recitem!(2, "Graphene"), recitem!(8, "Grating Crystal")),
                    (recitem!(1, "Casimir Crystal"))))));
        tohash!(res_hash,
            titanium_glass,
            "Titanium Glass",
            item!("Titanium Glass",
                (Assembler),
                (recipe!(5.0,
                    (recitem!(2, "Water"), recitem!(2, "Titanium Ingot"), recitem!(2, "Glass")),
        ...
        tohash!(res_hash,
            ...
            item!("Plane Filter",
                (Assembler),
                (recipe!(12.0,
                    (recitem!(2, "Titanium Glass"), recitem!(1, "Casimir Crystal")),
        ...
        tohash!(res_hash,
            ...
            item!("Logistics Bot",
                (Assembler),
                (recipe!(2.0,
                    (recitem!(1, "Processor"), recitem!(1, "Engine"), recitem!(2, "Iron Ingot")),
                    (recitem!(1, "Logistics Bot"))))));
        tohash!(res_hash,
            logisitcs_drone,
            "Logistics Drone",
            item!("Logistics Drone",
                (Assembler),
                (recipe!(4.0,
                    (recitem!(2, "Thruster"), recitem!(2, "Processor"), recitem!(5, "Iron Ingot")),
                    (recitem!(1, "Logistics Drone"))))));
        tohash!(res_hash,
            interstellar_logistics_vessel,
            "Interstellar Logistics Vessel",
            item!("Interstellar Logistics Vessel",
                (Assembler),
                (recipe!(6.0,
                    (recitem!(2, "Reinforced Thruster"), recitem!(10, "Processor"), recitem!(10, "Titanium Alloy")),
        ...
        tohash!(res_hash,
            deuterium_fuel_rod,
            "Deuterium Fuel Rod",
            item!("Deuterium Fuel Rod",
                (Assembler),
                (recipe!(12.0,
                    (recitem!(1, "Super-magnetic Ring"), recitem!(20, "Deuterium"), recitem!(1, "Titanium Alloy")),
                    (recitem!(2, "Deuterium Fuel Rod"))))));
        tohash!(res_hash,
            antimatter_fuel_rod,
            "Antimatter Fuel Rod",
            item!("Antimatter Fuel Rod",
                (Assembler),
                (recipe!(24.0,
                    (recitem!(1, "Titanium Alloy"), recitem!(1, "Annihilation Constraint Sphere"), recitem!(12, "Hydrogen"), recitem!(12, "Antimatter")),
                    (recitem!(2, "Antimatter Fuel Rod"))))));
        tohash!(res_hash,
            strange_anihilation_fuel_rod,
            "Strange Annihilation Fuel Rod",
            item!("Strange Annihilation Fuel Rod",
                (Assembler),
                (recipe!(32.0,
                    (recitem!(1, "Frame Material"), recitem!(2, "Strange Matter"), recitem!(1, "Core Element"), recitem!(8, "Antimatter Fuel Rod")),
        ...
        tohash!(res_hash,
            ...
            item!("Frame Material",
                (Assembler),
                (recipe!(6.0,
                    (recitem!(1, "High-purity Silicon"), recitem!(1, "Titanium Alloy"), recitem!(4, "Carbon Nanotube")),
                    (recitem!(1, "Frame Material"))))));
        tohash!(res_hash,
            dyson_sphere_component,
            "Dyson Sphere Component",
            item!("Dyson Sphere Component",
                (Assembler),
                (recipe!(8.0,
                    (recitem!(3, "Processor"), recitem!(3, "Solar Sail"), recitem!(3, "Frame Material")),
                    (recitem!(1, "Dyson Sphere Component"))))));
        tohash!(res_hash,
            small_carrier_rocket,
            "Small Carrier Rocket",
            item!("Small Carrier Rocket",
                (Assembler),
                (recipe!(6.0,
                    (recitem!(2, "Quantum Chip"), recitem!(4, "Deuterium Fuel Rod"), recitem!(2, "Dyson Sphere Component")),
                    (recitem!(1, "Small Carrier Rocket"))))));
        // Matrices
        tohash!(res_hash,
            electromagnetic_matrix,
            "Electromagnetic Matrix",
            item!("Electromagnetic Matrix",
                (Lab),
                (recipe!(3.0,
        ...
        tohash!(res_hash,
            universe_matrix,
            "Universe Matrix",
            item!("Universe Matrix",
                (Lab),
                (recipe!(15.0,
                    (recitem!(1, "Electromagnetic Matrix"), recitem!(1, "Energy Matrix"), recitem!(1, "Structure Matrix"), recitem!(1, "Information Matrix"), recitem!(1, "Gravity Matrix"), recitem!(1, "Antimatter")),
                    (recitem!(1, "Universe Matrix"))))));
        // ammunition
        tohash!(res_hash,
            magnum_ammo_box,
            "Magnum Ammo Box",
            item!("Magnum Ammo Box",
                (Assembler),
                (recipe!(1.0,
        ...
        tohash!(res_hash,
            titanium_ammo_box,
            "Titanium Ammo Box",
            item!("Titanium Ammo Box",
                (Assembler),
                (recipe!(2.0,
                    (recitem!(2, "Titanium Ingot"), recitem!(1, "Magnum Ammo Box")),
                    (recitem!(1, "Titanium Ammo Box"))))));
        tohash!(res_hash,
            superalloy_ammo_box,
            "Superalloy Ammo Box",
            item!("Superalloy Ammo Box",
                (Assembler),
                (recipe!(3.0,
                    (recitem!(1, "Titanium Alloy"), recitem!(1, "Titanium Ammo Box")),
        ...
        tohash!(res_hash,
            ...
            item!("Explosive Unit",
                (ChemicalPlant),
                (recipe!(6.0,
                    (recitem!(1, "Sulfuric Acid"), recitem!(2, "Plastic"), recitem!(2, "Combustible Unit")),
                    (recitem!(2, "Explosive Unit"))))));
        tohash!(res_hash,
            crystal_explosive_unit,
            "Crystal Explosive Unit",
            item!("Crystal Explosive Unit",
                (ChemicalPlant),
                (recipe!(24.0,
                    (recitem!(8, "Crystal Silicon"), recitem!(1, "Casimir Crystal"), recitem!(8, "Explosive Unit")),
        ...
        tohash!(res_hash,
            ...
            item!("Missile Set",
                (Assembler),
                (recipe!(2.0,
                    (recitem!(1, "Engine"), recitem!(2, "Combustible Unit"), recitem!(3, "Circuit Board"), recitem!(6, "Copper Ingot")),
                    (recitem!(1, "Missile Set"))))));
        tohash!(res_hash,
            supersonic_missile_set,
            "Supersonic Missile Set",
            item!("Supersonic Missile Set",
                (Assembler),
                (recipe!(4.0,
                    (recitem!(2, "Thruster"), recitem!(4, "Explosive Unit"), recitem!(4, "Processor"), recitem!(2, "Missile Set")),
                    (recitem!(2, "Supersonic Missile Set"))))));
        tohash!(res_hash,
            gravity_missile_set,
            "Gravity Missile Set",
            item!("Gravity Missile Set",
                (Assembler),
                (recipe!(6.0,
                    (recitem!(3, "Strange Matter"), recitem!(6, "Crystal Explosive Unit"), recitem!(3, "Supersonic Missile Set")),
        ...
        tohash!(res_hash,
            ...
            item!("High-Explosive Shell Set",
                (Assembler),
                (recipe!(3.0,
                    (recitem!(2, "Explosive Unit"), recitem!(6, "Titanium Ingot"), recitem!(1, "Shell Set")),
                    (recitem!(1, "High-Explosive Shell Set"))))));
        tohash!(res_hash,
            crystal_shell_set,
            "Crystal Shell Set",
            item!("Crystal Shell Set",
                (Assembler),
                (recipe!(6.0,
                    (recitem!(2, "Crystal Explosive Unit"), recitem!(3, "Titanium Ingot"), recitem!(1, "High-Explosive Shell Set")),
        ...
        tohash!(res_hash,
            ...
            item!("Plasma Capsule",
                (Assembler),
                (recipe!(2.0,
                    (recitem!(10, "Deuterium"), recitem!(2, "Magnet"), recitem!(1, "Graphene")),
                    (recitem!(1, "Plasma Capsule"))))));
        tohash!(res_hash,
            anitmatter_capsule,
            "Antimatter Capsule",
            item!("Antimatter Capsule",
                (Assembler),
                (recipe!(2.0,
                    (recitem!(10, "Antimatter"), recitem!(10, "Hydrogen"), recitem!(1, "Particle Container"), recitem!(1, "Plasma Capsule")),
                    (recitem!(1, "Antimatter Capsule"))))));
        tohash!(res_hash,
            jamming_capsule,
            "Jamming Capsule",
            item!("Jamming Capsule",
                (Assembler),
                (recipe!(2.0,
                    (recitem!(3, "Hydrogen"), recitem!(1, "Plasma Exciter"), recitem!(1, "Electromagnetic Turbine")),
                    (recitem!(1, "Jamming Capsule"))))));
        tohash!(res_hash,
            suppressing_capsule,
            "Suppressing Capsule",
            item!("Suppressing Capsule",
                (Assembler),
                (recipe!(8.0,
                    (recitem!(2, "Glass"), recitem!(1, "Super-magnetic Ring"), recitem!(2, "Jamming Capsule")),
        ...
        tohash!(res_hash,
            ...
            item!("Prototype",
                (Assembler),
                (recipe!(2.0,
                    (recitem!(1, "Plasma Exciter"), recitem!(2, "Circuit Board"), recitem!(1, "Engine"), recitem!(3, "Iron Ingot")),
                    (recitem!(1, "Prototype"))))));
        tohash!(res_hash,
            precision_drone,
            "Precision Drone",
            item!("Precision Drone",
                (Assembler),
                (recipe!(4.0,
                    (recitem!(2, "Photon Combiner"), recitem!(2, "Circuit Board"), recitem!(1, "Electromagnetic Turbine"), recitem!(1, "Prototype")),
        ...
        tohash!(res_hash,
            ...
            item!("Attack Drone",
                (Assembler),
                (recipe!(4.0,
                    (recitem!(1, "Particle Container"), recitem!(1, "Processor"), recitem!(1, "Electromagnetic Turbine"), recitem!(1, "Prototype")),
        ...
        tohash!(res_hash,
            ...
            item!("Corvette",
                (Assembler),
                (recipe!(5.0,
                    (recitem!(3, "Particle Container"), recitem!(2, "Processor"), recitem!(1, "Reinforced Thruster"), recitem!(5, "Titanium Alloy")),
                    (recitem!(1, "Corvette"))))));
        tohash!(res_hash,
            destroyer,
            "Destroyer",
            item!("Destroyer",
                (Assembler),
                (recipe!(8.0,
                    (recitem!(1, "Strange Matter"), recitem!(4, "Processor"), recitem!(4, "Reinforced Thruster"), recitem!(20, "Frame Material")),
                    (recitem!(1, "Destroyer"))))));
